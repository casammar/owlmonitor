...
/*----------------------------------------------------*/
	...
	jQuery(document).ready(function(){
		...
		switch(ev.value) {
		    case (1):
			$("#front-page-background-banner").css("background-image", "url('./img/sandbox/frontpage/IMG_1461.jpg')");
			break;
		    case (2):
			$("#front-page-background-banner").css("background-image", "url('./img/sandbox/frontpage/IMG_1464.jpg')");
			break;
		    case (3):
			$("#front-page-background-banner").css("background-image", "url('./img/sandbox/frontpage/IMG_1471.jpg')");
			$("#front-page-background-banner").css("background-position", "center top");
			break;
		    case (4):
			$("#front-page-background-banner").css("background-image", "url('./img/sandbox/frontpage/IMG_1472.jpg')");
			break;
		    case (5):
			$("#front-page-background-banner").css("background-image", "url('./img/sandbox/frontpage/IMG_1481.jpg')");
			break;
		}
	    });
	});
