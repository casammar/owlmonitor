			...
			<div class="row">
				...
				<div class="choice col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<div class="step">
						...
						<h2>Step Two</h2>
						<p>
							Curabitur laoreet urna vel ante molestie facilisis.
						</p>
					...
					<div class="step">
						...
						<h2>Step Three</h2>
						<p>
							Aliquam sem eros, sodales et sapien ac, dignissim suscipit nunc.
						</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<h3 class="title">Three Reasons ExamHawk is Awesome</h3>
				</div>
				<div class="divider">
				</div>
				<div class="reasons">
